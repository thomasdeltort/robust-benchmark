...
python hybrid_verification.py --model_path /home/aws_install/robust-benchmark/models/vanilla_ConvLarge_CIFAR10_1_LIP_Bjork_cifar10_tau_a250.0_T1.0_bs128_lr0.001_eps0.01_heavy_1765374676_acc0.75.pth --model "ConvLarge_CIFAR10_1_LIP_Bjork" --dataset cifar10 --epsilon 0.08 --split_index 3  --batch_size 1 --high_tau True
...
python main_auto.py \
  ...
  --batch_size 1 \
  --high_tau True \
  --output_csv results_highlowtau/bjork_T400_split${SPLIT_IDX}_study_hightau.csv
...
python main_auto.py \
  ...
  --split_index $SPLIT_IDX \
  --batch_size 1 \
  --output_csv results_highlowtau/bjork_T400_split${SPLIT_IDX}_study_lowtau.csv
